...
const mapFavouritePageStateToProps = (state: ReduxStore) => {
  return {
...
const mapFavouritePageDispatchToProps = (dispatch: ThunkDispatch<Action, any, any>) => ({
});
...
class FavouriteSong extends Component<favouritePageProps, favouritePageState>{ 
...
/* 
  ...
  componentDidMount = () => {
    console.log(this.props.listSongs.song)

   console.log(this.props.songLiked.list)
this.setState({songsfavourite: this.props.songLiked.list})
  }
  componentDidUpdate(prevProps: any) {
    if (this.props.songLiked.list.length!== prevProps.songLiked.list.length) {
      this.setState({selected: this.props.album.albumSelected,songs: this.props.listSongs.song, songsfavourite: this.props.songLiked.list
      });
    }
  }
render(){
  return (
    <div className="main">
      ...
      <MyNavbar />
        ...
        {this.state.songsfavourite.length >= 1 ? (<div>
          <h2>Album</h2>

         {this.state.songsfavourite.map((song, i) => (
...
export default connect(mapFavouritePageStateToProps, mapFavouritePageDispatchToProps)(FavouriteSong);
